      ...
      <nav className="NavDesktop">
        <ul className="NavDesktop--list">
          ...
          <button
            ...
            className={classNames("showLanternListDesktop", { active: isLanternsDark })}>
            <img
              className="arrowDesktop"
              src={isLanternListOpened ? arrowLight : arrowDark}
              alt="strzałka rozwijająca listę latarni" />
            <p>latarnie</p>
          </button>
